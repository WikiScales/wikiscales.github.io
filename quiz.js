...
var questions = [
  ...
  {
    question: "Я поддерживаю политику колониализма — создания участниками с крупного википроекта отдельных вики, с целью сделать их впоследствии доминионами основного проекта.",
    answer: 0,
    valuesYes: [
      {
        axis: "t1",
  ...
  {
    question: "Я состою в каком-либо викисоюзе с разными вики, и при этом поддерживаю проведение политики экспансии — присоединения к викисоюзу новых википроектов.",
    answer: 0,
    valuesYes: [
      {
        axis: "expan",
