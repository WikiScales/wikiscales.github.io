...
var questions = [
  ...
  {
    question: "Лучше, чтобы проводить различные реформы можно было только при их одобрении народа (большим количеством участников).",
    answer: 0,
    valuesYes: [
      {
        axis: "c0",
  ...
  {
    question: "Я ничего не имею против участников, которые активно используют в своей речи пошлые, вульгарные и непристойные выражения.",
    answer: 0,
    valuesYes: [
      {
        axis: "j0",
  ...
  {
    question: "Нет ничего плохого в том, если какой-либо участник при общении зачастую намеренно подвергает слова умышленному искажению, либо активно использует сленг и жаргон.",
    answer: 0,
    valuesYes: [
      {
        axis: "j0",
