...
var questions = [
  ...
  {
    question: "В первую очередь администратор должен думать не о своих правах, а об обязанностях перед участниками. Статус «администратор» — это не награда, поскольку уровень обязательств очень высок.",
    answer: 0,
    valuesYes: [
      {
        axis: "c0",
  ...
  {
    question: "Чем больше пользователей могут активно влиять на общественно-социальную жизнь на википроекте и принимаемые решения, тем лучше (например, благодаря свободному участию в обсуждениях с администрацией, с предложениями касательно возможных дальнейших улучшений википроекта).",
    answer: 0,
    valuesYes: [
      {
        axis: "c0",
  ...
  {
    question: "Я редко помогаю участникам, и чаще всего думаю только о себе и своих проблемах.",
    answer: 0,
    valuesYes: [
      {
        axis: "s1",
  ...
  {
    question: "В процессе работы я зачастую не позволяю другим оказывать какое-либо влияние на свои действия.",
    answer: 0,
    valuesYes: [
      {
        axis: "s1",
  ...
  {
    question: "У меня мало социальных связей на вики, я редко общаюсь с кем-либо.",
    answer: 0,
    valuesYes: [
      {
        axis: "s1",
  ...
  {
    question: "Один из важнейших принципов существования вики в том, что коллектив имеет бóльшую сумму знаний, чем каждый отдельный человек.",
    answer: 0,
    valuesYes: [
      {
        axis: "s0",
  ...
  {
    question: "Нередко случаются ситуации, когда я принимаю решения исходя исключительно из своих побуждений, не учитывая общественное мнение.",
    answer: 0,
    valuesYes: [
      {
        axis: "s1",
  ...
  {
    question: "Сотрудничество с участниками ради общих интересов — важнейший компонент развития взаимоотношений и существования вики.",
    answer: 0,
    valuesYes: [
      {
        axis: "s0",
  ...
  {
    question: "Лучше не делать список правил википроекта излишне длинным и подробным — это лишь напугает участников и оттолкнёт их читать правила. Лучше сделать небольшой, короткий, но понятный и доступный для всех список правил, не содержащий канцелярита.",
    answer: 0,
    valuesYes: [
      {
        axis: "c0",
  ...
  {
    question: "Зачастую не стоит банить нарушителей сроком более чем на месяц. Мягких мер наказания вполне достаточно для поддержания порядка.",
    answer: 0,
    valuesYes: [
      {
        axis: "b0",
  ...
  {
    question: "Участника можно блокировать лишь в том случае, если будет доказано, что он нарушил правила. А до тех пор, пока прямых доказательств его вины нет, участника можно считать невиновным.",
    answer: 0,
    valuesYes: [
      {
        axis: "b0",
  ...
  {
    question: "Я считаю отстаивание интересов википроекта(-ов) (на котором(-ых) я занимаюсь правками) во внешней политике (межпроектных отношениях) не менее важным, чем развитие внутреннего устройства вики (Не знаю/Не уверен — я не занимаюсь правками на википроектах).",
    answer: 0,
    valuesYes: [
      {
        axis: "t1",
  ...
  {
    question: "Я считаю, что википроекты схожих тематик должны объединяться в викисоюзы или альянсы (Не знаю/Не уверен — меня не интересуют викисоюзы и альянсы).",
    answer: 0,
    valuesYes: [
      {
        axis: "t1",
  ...
  {
    question: "Викисоюзы и альянсы могут представлять угрозу суверенитету отдельным и независимым википроектам (Не знаю/Не уверен — меня не интересуют викисоюзы и альянсы).",
    answer: 0,
    valuesYes: [
      {
        axis: "t0",
  ...
  {
    question: "Викисоюзы, как правило, не несут в себе никакой реальной пользы и существуют только на словах. Они не приводят ни к чему хорошему, и часто совершенно не нужны википроектам (Не знаю/Не уверен — меня не интересуют викисоюзы и альянсы).",
    answer: 0,
    valuesYes: [
      {
        axis: "t0",
  ...
  {
    question: "Я поддерживаю проведение каким-либо викисоюзом (в котором я состою лично, либо в котором я заинтересован) политики экспансии — активной интеграции и присоединения к викисоюзу новых википроектов (Не знаю/Не уверен — меня не интересуют викисоюзы и альянсы).",
    answer: 0,
    valuesYes: [
      {
        axis: "expan",
  ...
  {
    question: "Интервенция (вмешательство) какого-либо крупного викисоюза в дела отдельно взятого википроекта, в том числе с целью присоединения к союзу последнего, идёт на пользу обоим сторонам (Не знаю/Не уверен — меня не интересуют викисоюзы и альянсы).",
    answer: 0,
    valuesYes: [
      {
        axis: "expan",
