...
var questions = [
  ...
  {
    question: "Я считаю отстаивание интересов википроекта(-ов) (на котором(-ых) я занимаюсь правками) во внешней политике (межпроектных отношениях) не менее важным, чем развитие внутреннего устройства вики.",
    answer: 0,
    valuesYes: [
      {
        axis: "t1",
