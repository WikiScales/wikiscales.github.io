...
var questions = [
  ...
  {
    question: "Проводить различные реформы нужно только при их одобрении их народом (большим количеством участников), посредством проведения голосований; каждый обычный участник должен иметь право голоса и право свободно участвовать в таком голосовании.",
    answer: 0,
    valuesYes: [
      {
        axis: "c0",
