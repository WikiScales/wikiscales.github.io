...
var questions = [
  ...
  {
    question: "Деятельность администрации википроекта должна быть максимально «прозрачной» — не бывает ничего такого, что требовалось бы скрывать от обычных участников (например, делать логи доступным для просмотра только администрации вики).",
    answer: 0,
    valuesYes: [
      {
        axis: "c0",
