...
var questions = [
  ...
  {
    question: "Правила должны распространяться на всех участников сообщества в равной степени, исключений (право не соблюдать правила в определённых ситуациях) не должно быть ни у кого, даже у администрации.",
    answer: 0,
    valuesYes: [
      {
        axis: "c0",
