...
var questions = [
  ...
  {
    question: "Проводить различные реформы нужно только при их одобрении их народом (большим количеством участников), поэтому на википроектах должны открыто проводиться голосования; каждый обычный участник должен иметь право голоса и право свободно участвовать в таком голосовании.",
    answer: 0,
    valuesYes: [
      {
        axis: "c0",
  ...
  {
    question: "На википроектах должны открыто проводиться референдумы, на которых должны решаться все спорные моменты, а также те или иные важные вопросы с как можно большим количеством обычных участников.",
    answer: 0,
    valuesYes: [
      {
        axis: "c0",
  ...
  {
    question: "Администрация, вне зависимости от результатов голосования/обсуждения, может иметь право принимать иное решение и поступать по-своему.",
    answer: 0,
    valuesYes: [
      {
        axis: "c1",
  ...
  {
    question: "Я считаю, что вики-общество без элиты нежизнеспособно.",
    answer: 0,
    valuesYes: [
      {
        axis: "c1",
  ...
  {
    question: "Многие вопросы, касаемые тех или иных сторон википроекта, не обязательн, либо не нужно выносить на обсуждение/референдум перед всеми участниками — вместо этого, можно решить их в узком кругу экспертных участников.",
    answer: 0,
    valuesYes: [
      {
        axis: "c1",
  ...
  {
    question: "Не случилось таких ситуаций, когда я хотел бы сделать что-то, что принесло бы пользу и выгоду исключительно мне самому.",
    answer: 0,
    valuesYes: [
      {
        axis: "s0",
  ...
  {
    question: "Лучший способ исправить участника-нарушителя — поговорить с ним о его поведении, направить его на «правильный путь», вместо того чтобы выдавать блокировку.",
    answer: 0,
    valuesYes: [
      {
        axis: "b0",
  ...
  {
    question: "Я считаю, что новые профили и стены обсуждений участников единой платформы, сделанные на основе технологии обсуждений, гораздо лучше, практичнее и удобнее старых стен обсуждения, сделанных на основе MediaWiki.",
    answer: 0,
    valuesYes: [
      {
        axis: "p1",
  ...
  {
    question: "Удаление форумов и полная замена их на обсуждения — крайне предательский и подлый ход со стороны Фэндома.",
    answer: 0,
    valuesYes: [
      {
        axis: "p0",
  ...
  {
    question: "Я считаю, что очень важно поддерживать дружественные отношения между википроектами-единомышленниками, либо википроектами на схожую тематику.",
    answer: 0,
    valuesYes: [
      {
        axis: "t1",
  ...
  {
    question: "Я считаю дипломатические отношения между разными википроектами очень важными, ценными и полезными.",
    answer: 0,
    valuesYes: [
      {
        axis: "t1",
  ...
  {
    question: "Нет ничего плохого в том, если участники крупного википроекта решат создать отдельные вики, и впоследствии сделать их доминионами основного проекта.",
    answer: 0,
    valuesYes: [
      {
        axis: "t1",
  ...
  {
    question: "Нет ничего плохого в том, если какой-либо крупный викисоюз с разными вики решит расшириться, присоединив к себе новые проекты.",
    answer: 0,
    valuesYes: [
      {
        axis: "t1",
  ...
  {
    question: "Я — сторонник политики деколонизации, и считаю, что необходимо предоставлять независимость любым вики-доминионам.",
    answer: 0,
    valuesYes: [
      {
        axis: "t0",
  ...
  {
    question: "Не стоит делить информацию о чём-либо, создавая короткие статьи, а вместо этого лучше стараться максимально изложить информацию в одной большой статье (не согласен – большие статьи лучше всегда разделять на отдельные, меньшие по размеру; каждой теме должно быть уделено особое внимание).",
    answer: 0,
    valuesYes: [
      {
        axis: "merge",
  ...
  {
    question: "Я предпочитаю заниматься развитием энциклопедической стороны вики (созданием и наполнением статей и связанных с ними данных), а не социальной (не согласен – я предпочитаю заниматься социальной стороной, тогда как качеством и наполнением статей можно пренебречь; первостепенной задачей википроекта должно быть развитое общество и взаимоотношения, высокая активность участников в чате).",
    answer: 0,
    valuesYes: [
      {
        axis: "exo",
