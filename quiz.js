...
var questions = [
  ...
  {
    question: "Интервенция (вмешательство) какого-либо крупного викисоюза в дела отдельно взятого википроекта, в том числе с целью присоединения к союзу последнего, идёт на пользву обоим сторонам.",
    answer: 0,
    valuesYes: [
      {
        axis: "expan",
